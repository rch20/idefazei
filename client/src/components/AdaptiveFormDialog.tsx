...
export function AdaptiveFormDialogContent({
  ...
  return (
    <DialogContent
      className={cn(
        "inset-0 h-[100dvh] max-h-[100dvh] w-screen max-w-none translate-x-0 translate-y-0 grid-rows-[auto_minmax(0,1fr)_auto] gap-0 overflow-hidden rounded-none border-0 p-0 shadow-none",
