...
describe("Fluxo estrutural da Configuração da Igreja", () => {
  ...
  it("personaliza e controla o cadastro público por tenant com link oficial copiável", () => {
    ...
    expect(settingsSource).toContain("Baixar PNG 16:9 para telão");
    expect(settingsSource).toContain("PNG vertical");
    expect(settingsSource).toContain("PNG simples");
    expect(settingsSource).toContain("SVG 16:9");
    expect(settingsSource).toContain("SVG vertical");
    expect(settingsSource).toContain("publicRegistrationQrUrl");
    expect(settingsSource).toContain('handleDownloadQr("landscape-png")');
    expect(settingsSource).toContain('handleDownloadQr("portrait-png")');
    expect(settingsSource).toContain('handleDownloadQr("simple-png")');
    expect(settingsSource).toContain('handleDownloadQr("landscape-svg")');
    ...
    expect(settingsSource).toContain("width=\"695\" height=\"695\"");
    expect(settingsSource).toContain("Leia com a câmera");
    expect(settingsSource).toContain("QR Code</p>");
