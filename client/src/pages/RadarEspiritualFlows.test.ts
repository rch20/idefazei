...
const radarStart = dbSource.indexOf("export async function getSpiritualRadarByChurch");
const radarSource = dbSource.slice(radarStart, dbSource.indexOf("export async function setCurrentCareAssignment", radarStart));
